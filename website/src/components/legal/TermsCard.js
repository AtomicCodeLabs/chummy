...
const TermsCard = () => (
  <div className="max-w-6xl px-16 py-16 my-16 bg-white rounded-lg shadow-lg">
    <h3 id="agreementtoterms">Agreement to Terms</h3>

    <P>
      These Terms of Use constitute a legally binding agreement made between
      you, whether personally or on behalf of an entity (“you”) and Atomic Code
      ("<strong>Company</strong>", “<strong>we</strong>”, “<strong>us</strong>”,
      or “<strong>our</strong>”), concerning your access to and use of the
      chummy.atomiccode.io website as well as any other media form, media
    ...
    <h3 id="intellectualpropertyrights">Intellectual Property Rights</h3>
    ...
    <h3 id="userrepresentations">User Representations</h3>
    ...
    <h3 id="feesandpayment">Fees and Payment</h3>
    ...
    <h3 id="freetrial">Free Trial</h3>

    <P>
      We offer a 30-day free trial for the Professional Edition to new users who
      register with the Site. The account will be charged according to the
    ...
    <P>
      ...
      solely in connection with our services and in accordance with these Terms
      of Use. Any Software and any related documentation is provided “as is”
    ...
    <h3 id="prohibitedactivities">Prohibited Activities</h3>

    <ol className="ml-8 list-decimal list-outside">
      <li>
    ...
    <h3 id="usergeneratedcontributions">User Generated Contributions</h3>
    ...
    <h3 id="contributionlicense">Contribution License</h3>
    ...
    <h3 id="thirdpartywebsitesandcontent">Third-Party Websites and Content</h3>
    ...
    <h3 id="usgovernmentrights">U.S. Government Rights</h3>
    ...
    <h3 id="sitemanagement">Site Management</h3>
    ...
    <h3 id="termandtermination">Term and Termination</h3>
    ...
    <h3 id="modificationsandinterruptions">Modifications and Interruptions</h3>
    ...
    <h3 id="disputeresolution">Dispute Resolution</h3>

    <h4 id="informalnegotiations">Informal Negotiations</h4>
    ...
    <h4 id="bindingarbitration">Binding Arbitration</h4>
    ...
    <P>
      ...
      <a href="http://www.adr.org">www.adr.org</a>. Your arbitration fees and
      ...
      will take place in King County, Washington. Except as otherwise provided
    ...
    <P>
      ...
      courts located in King County, Washington, and the Parties hereby consent
    ...
    <h4 id="exceptionstoinformalnegotiationsandarbitration">
    ...
    <h3 id="limitationsofliability">Limitations of Liability</h3>
    ...
    <h3 id="electroniccommunicationstransactionsandsignatures">
