...
const PrivacyCard = () => (
  <div className="max-w-6xl px-16 py-16 my-16 bg-white rounded-lg shadow-lg">
    <P>
      Thank you for choosing to be part of our community at Atomic Code ("
    ...
    <P>
      ...
      <a href="https://chummy.atomiccode.io">https://chummy.atomiccode.io</a>{' '}
      (the "<strong>Website</strong>"), and more generally, use any of our
      services (the "<strong>Services</strong>", which include the Website), we
    ...
    <h4 id="personalinformationyoudisclosetous">
    ...
    <P>
      <strong>Personal Information Provided by You.</strong> We collect account
      type; user bookmarks; and other similar information.
    </P>
    ...
    <P>
      ...
      choose to register in this way, we will collect the Information described
    ...
    <h4 id="informationautomaticallycollected">
    ...
    <ul>
      ...
      <Li>
        <P>
          ...
          as part of our efforts to keep our Website safe and secure (for
    ...
    <P>
      ...
      <a href="https://chummy.atomiccode.io/account/privacy">
        https://chummy.atomiccode.io/account/privacy
      </a>
